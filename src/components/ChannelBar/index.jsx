  ...
  return (
    <div className="dropdown m-0 w-full pb-2 transition duration-300 ease-in-out">
      <div
        ...
        className="dropdown-header mx-0 flex cursor-pointer flex-row
...
const TopicSelection = ({ selection }) => (
  <div
    className="dropdown-selection ml-2 mr-auto mt-1 flex
    cursor-pointer flex-row items-center
    justify-evenly transition duration-300
    ease-in-out">
    <BsHash size="24" className="text-gray-400" />
    <h5
      className="dropdown-selection-text mr-auto cursor-pointer font-semibold
    tracking-wide
